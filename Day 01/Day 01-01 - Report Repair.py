...
value1 = 0
while value1 < len(expense_report):
    value1 += 1
    value2 = value1 + 1
    while value2 < len(expense_report):
        total_value = int(expense_report[value1]) + int(expense_report[value2])
        if total_value == 2020:
            print("Line", value1, "( Value", int(expense_report[value1]), ") +",
                  "Line", value2, "( Value", int(expense_report[value2]), ") = 2020")
            print("Multiplied this is", int(expense_report[value1]) * int(expense_report[value2]))
        value2 += 1
