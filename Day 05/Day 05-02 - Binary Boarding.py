...
def check_for_free_seat(list_of_seats):
    previous_seat_number = 0
    free_seat = 0
    for seat_number in list_of_seats:
        if previous_seat_number != 0 and (seat_number - previous_seat_number != 1):
            free_seat = seat_number
            return free_seat - 1
        previous_seat_number = seat_number
    return free_seat
...
print("Highest Seat ID: ", sorted(list_of_seat_IDs)[-1])
my_seat = check_for_free_seat(sorted(list_of_seat_IDs))
print("My seat (the free one) is:", my_seat)
