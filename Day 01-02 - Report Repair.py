...
line1 = 0
loop_counter = 0
length_of_report = len(expense_report)
while line1 < length_of_report:
    value1 = int(expense_report[line1])
    line1 += 1
    line2 = line1 + 1
    loop_counter += 1
    while line2 < length_of_report:
        value2 = int(expense_report[line2])
        line2 += 1
        line3 = line2 + 1
        loop_counter += 1
        while line3 < length_of_report:
            value3 = int(expense_report[line3])
            line3 += 1
            total_value = value1 + value2 + value3
            if total_value == 2020:
                print("Line", line1, "( Value", value1, ") +",
                      "Line", line2, "( Value", value2, ") +",
                      "Line", line3, "( Value", value3, ") = 2020")
                print("Multiplied this is", value1 * value2 * value3)
            loop_counter += 1
